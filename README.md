...
- [KSEQ (JS)](https://github.com/nkohari/kseq)
- [Automerge(JS)](https://github.com/automerge/automerge)
- [Teletype (JS)](https://github.com/atom/teletype-crdt)
- [Yjs (JS)](https://github.com/yjs/yjs)
### Rust
- [G Counter (Rust)](https://github.com/danburkert/crdt/blob/master/src/counter/gcounter.rs)
- [PN Counter (Rust)](https://github.com/danburkert/crdt/blob/master/src/counter/pncounter.rs)
- [ORSWOT (Rust)](https://github.com/davidrusu/bft-crdts/tree/master/src/orswot)
- [RON (Rust)](https://github.com/flanfly/ron-crdt)
### Go
- [G Counter (Go)](https://github.com/neurodrone/crdt/blob/master/g_counter.go)
- [G Set (Go)](https://github.com/neurodrone/crdt/blob/master/g_set.go)
- [LWW-Element-Set (Go)](https://github.com/neurodrone/crdt/blob/master/lww_e_set.go)
- [OR Set (Go)](https://github.com/neurodrone/crdt/blob/master/or_set.go)
